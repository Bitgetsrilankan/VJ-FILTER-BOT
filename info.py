...
reqst_channel = environ.get('REQST_CHANNEL', '-1002423115280')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002278073091').split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://amanshah.serv00.net/images/BqRZWWv/file-150.jpg') # payment code picture url.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/oh_th')
