...
BOT_TOKEN = environ.get('BOT_TOKEN', "7221872059:AAEbapt-vAFL-csOALOpt1Y2sXpsXQOLWvg")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://pawanivimasha8:20030928@autofilter.jdtmx.mongodb.net/?retryWrites=true&w=majority&appName=AutoFilter") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'FilmJoyHub1') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
